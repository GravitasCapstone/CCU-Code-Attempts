...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U3RX, INPUT_PIN_RPC4 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U4RX, INPUT_PIN_RPE8 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U5RX, INPUT_PIN_RPB9 );
    ...
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U5TX, OUTPUT_PIN_RPB3 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U6TX, OUTPUT_PIN_RPB0 );
